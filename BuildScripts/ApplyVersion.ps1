...
# retrieve the necessary environment-variables, provided by the build-service (https://msdn.microsoft.com/Library/vs/alm/Build/scripts/variables)
$buildNumber = Get-EnvironmentVariable -Name "BUILD_BUILDNUMBER" -Verbose:$VerbosePreference
$sourcesDirectory = Get-EnvironmentVariable -Name "BUILD_SOURCESDIRECTORY" -Verbose:$VerbosePreference
